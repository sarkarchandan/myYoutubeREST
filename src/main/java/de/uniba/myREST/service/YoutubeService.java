...
/**
 * Provide the users a search functionality for Youtube videos with a search query as a RESTful API
...
public class YoutubeService{
    ...
    public Response getYoutubeVideos(@QueryParam("searchQuery") String searchQuery,@QueryParam("noOfResources") long noOfResources){
        ...
        try {
            ...
            loggerYoutubeService.log(Level.SEVERE,"Application has encountered an Internal Server Error");
